...
const tables = [
  {
    name: "names",
    columns: [
      { name: "primaryName", type: "string", defaultValue: "undefined" },
      { name: "birthYear", type: "int" },
      { name: "deathYear", type: "int" },
      { name: "primaryProfession", type: "multiple" },
      { name: "knownForTitles", type: "multiple" },
      { name: "pictureUrl", type: "string", defaultValue: "undefined" },
...
const defaultOptions = {
  databaseURL:
    "https://Bal-zs-Orb-n-s-workspace-6q9fhb.eu-west-1.xata.sh/db/test",
};
